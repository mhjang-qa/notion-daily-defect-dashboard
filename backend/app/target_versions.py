...
HANPASS_RENEWAL_NATIVE = "[Hanpass][앱개편][Native]-Dev"
HANPASS_RENEWAL_NATIVE_LIVETEST = "[Hanpass][앱개편][Native]-LiveTest"
HANPASS_RENEWAL_BO = "[Hanpass][앱개편][BO]"
HANPASS_RENEWAL_PLANNING = "[Hanpass][앱개편][기획]"
LEGACY_HANPASS_RENEWAL_NATIVE = "[Hanpass][앱개편]"
LEGACY_HANPASS_RENEWAL_NATIVE_DETAIL = "[Hanpass][앱개편][Native]"
...
_ALIASES = {
    ...
    LEGACY_HANPASS_RENEWAL_NATIVE_DETAIL: HANPASS_RENEWAL_NATIVE,
}
